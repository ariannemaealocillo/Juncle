...
$query_push_delete_collector = "UPDATE collector
SET account_status = '3' where collector_id = '".$post_params_field_array_data_value[0]."'";

$query_run = mysqli_query($connection, $query_push_delete_collector);
